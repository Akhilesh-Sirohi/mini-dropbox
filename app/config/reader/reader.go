// Package reader has specific primitives for loading application configurations.
//
// Primitives:
//   - Application should have struct for containing configuration. E.g. refer
//     go-foundation/internal/config/config.go file.
//   - Application should have a directory holding default file and environment
//     specific file. E.g. refer go-foundation/configs/* directory.
//
// Usage:
...
func (c *Config) loadByConfigName(configName string, config interface{}) error {
	c.viper.SetEnvPrefix(strings.ToUpper("mini-dropbox"))
